...
<div class="sortable row-fluid">
    <a data-rel="tooltip" title="<?= count($total_admin); ?> Admin" class="well span3 top-block" href="#">
    ...
    <a data-rel="tooltip" title="<?= count($total_review); ?> Review" class="well span3 top-block" href="#">
        <span class="icon32 icon-color icon-star-on"></span>
        <div>Total Review</div>
        <div><?= count($total_review); ?></div>
        <span class="notification green">2</span>
    </a>

    <a data-rel="tooltip" title="<?= count($total_user); ?> User" class="well span3 top-block" href="#">
        <span class="icon32 icon-color icon-user"></span>
        <div>Total User</div>
        <div><?= count($total_user); ?></div>
...
<div class="row-fluid">
    <div class="box span12">
        ...
        <div class="box-content">
            <h1>Total Review <small>this is one of the free Review application.</small></h1>
            <p>Its a live demo of the template. I have created it to ease the repeat work I have to do on my projects. Now I re-use it as a base for my admin panel work :)</p>
        ...
        <div class="box-content">
            ...
            <div id="myTabContent" class="tab-content">
                <div class="tab-pane active" id="info">
                    ...
                    <p>Its a fully featured, responsive template for your admin panel. Its optimized for tablet and mobile phones. Scan the QR code below to view it in your mobile device.</p> <img alt="QR Code" class="charisma_qr center" src="<?= base_url('images/gal4.jpg') ?>" />
                </div>
